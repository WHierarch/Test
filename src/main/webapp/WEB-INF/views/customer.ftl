...
<body>
    ...
    <table id="dg" title="用户管理" class="easyui-datagrid" pagination="true"
	   rownumbers="true" url="${ctx}/customer/queryCustomersByParams" fit="true" toolbar="#tb">
...
<div id="tb">
	<div>
		<a href="javascript:openCustomerAddDialog()" class="easyui-linkbutton"
			iconCls="icon-add" plain="true">创建</a> <a
			...
			href="javascript:openCustomerOtherInfo('联系人管理',1)"
			class="easyui-linkbutton" iconCls="icon-lxr" plain="true">联系人管理</a> <a
			href="javascript:openCustomerOtherInfo('交往记录管理',2)"
	...
	<div>
		&nbsp;客户编号： &nbsp;<input type="text" id="s_khno" size="20"
			onkeydown="if(event.keyCode==13) searchCustomer()" /> &nbsp;客户名称：
		&nbsp;<input type="text" id="s_name" size="20"
		...
		<table cellspacing="8px">
			...
			<tr>
				...
				<td><input class="easyui-combobox" id="cusManager"
					name="cusManager"
					data-options="panelHeight:'auto',editable:false,valueField:'userName',textField:'userName',url:'${ctx}/user/queryCustomerManager'" />&nbsp;
					<font color="red">*</font></td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>客户等级：</td>
				<td><input class="easyui-combobox" id="level" name="level"
					data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${ctx}/dataDic/queryDataDicsByDicName?dicName=客户等级'" />&nbsp;<font
					color="red">*</font></td>
			</tr>
			<tr>
				<td>客户满意度：</td>
