...
<div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 200px;padding: 10px">
    <table cellspacing="8px">
        ...
        <tr>
            ...
            <td>    </td>
            <td>客户编号</td>
            <td><input type="text"  readonly="readonly" value="${(customer.khno)!""}"/></td>
        </tr>
    </table>
</div>
<br/>

<table id="dg" class="easyui-datagrid" title="客户订单记录" style="width:700px;height:250px"
        idField="id" pagination="true" rownumbers="true" 
        url="${ctx}/customerOrder/queryCustomerOrdersByCid?cid=${customer.id}" singleSelect=true>
    <thead>
    <tr>
        <th field="id" >编号</th>
        <th field="orderNo" >订单号</th>
        <th field="orderDate">订单日期</th>
        <th field="address">地址</th>
        <th field="state" formatter="formatterState" >状态</th>
...
<div id="dlg-buttons">
	<a href="javascript:closeOrderDetailDialog()" class="easyui-linkbutton"
